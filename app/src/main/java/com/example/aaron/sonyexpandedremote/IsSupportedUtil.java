...
public class IsSupportedUtil {
     ...
     * @return
     */
    protected static boolean isSupportedServerVersion(JSONObject replyJson) {
        try {
     ...
     * @return
     */
    protected boolean isSupportedShootMode(String mode) {
     ...
     * @return
     */
    protected static boolean isCameraApiAvailable(String apiName, Set<String> mAvailableApiSet) {
     ...
     */
    protected static boolean isShootingStatus(String currentStatus) {
